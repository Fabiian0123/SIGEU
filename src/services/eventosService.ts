...
const demoEvents: Event[] = [
  {
    ...
    semestre: '8',
    observaciones: 'Traer laptop para ejercicios prácticos',
  ...
  },
  {
    ...
    carrera: 'Ingeniería en Sistemas',
    semestre: '6',
    observaciones: 'Evento de 2 días. Inscripción limitada a 30 personas',
  ...
  },
  {
    ...
    semestre: '7',
    observaciones: 'Dirigido a estudiantes interesados en crear negocios propios',
  ...
  },
  {
    ...
    carrera: 'Todas',
    semestre: 'Todos',
    observaciones: 'Evento abierto a toda la comunidad universitaria',
